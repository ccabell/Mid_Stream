...
export interface RunOutputs {
  prompt_1?: { parsed_json?: V2Pass1Output | { passes?: ParsedPass[] }; raw?: string };
  prompt_2?: { parsed_json?: V2Pass2Output | { passes?: ParsedPass[] }; raw?: string };
  ...
  /** Value metrics computed from offerings */
...
export interface V2PatientGoals {
  ...
  concern_areas?: FieldWithEvidence<string[]>;
...
export interface V2Pass1Output {
  ...
  interests?: {
    stated_interests?: FieldWithEvidence<string[]>;
    future_interests?: V2FutureInterest[];
  };
...
export interface V2PatientSignals {
  ...
  intent_score?: FieldWithEvidence<number>;
  sentiment_final?: FieldWithEvidence<number>;
...
export interface Opportunity {
  ...
  /** Optional practice context for filtering. */
  practice_id?: string | null;
  practice_name?: string | null;
  /** Optional owner/provider context for filtering. */
  provider_id?: string | null;
  provider_name?: string | null;
  owner_name?: string | null;
  /** Optional dates for sorting. */
  next_activity_at?: string | null;
  created_at?: string | null;
  /** Optional scoring for sorting/visuals. */
...
/** Practice from prompt-runner (GET /practices) */
